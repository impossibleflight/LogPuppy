...
public func assertOrLog(_ condition: @autoclosure () -> Bool, _ message: @autoclosure () -> String, logger: Logger, file: String = #file, line: Int = #line) {
...
public func assertionFailureOrLog(_ message: @autoclosure () -> String, logger: Logger, file: String = #file, line: Int = #line) {
